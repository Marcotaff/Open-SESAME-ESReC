...
axs[1].plot(Res.calculation_iteration,Res.SoR_Tot,'ro-',label="Total SoR increasing")
axs[1].plot(Res.calculation_iteration,Res.SoR_Cyc,'--o',alpha=0.5,label="SoR incr. caused by Cyclic aging")
axs[1].plot(Res.calculation_iteration,Res.SoR_Cal,'--o',alpha=0.5,label="SoR incr. caused by Calandaric aging")
axs[1].legend()
